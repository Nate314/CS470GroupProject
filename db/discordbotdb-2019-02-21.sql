...
CREATE TABLE `discordusers` (
  `DiscordUserID` int(11) NOT NULL AUTO_INCREMENT,
  `UserName` varchar(32) NOT NULL,
  `UserHash` int(4) DEFAULT NULL,
...
INSERT INTO `resources` VALUES (1,'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Facebook_icon_2013.svg/500px-Facebook_icon_2013.svg.png'),(2,'https://abs.twimg.com/icons/apple-touch-icon-192x192.png'),(3,'https://instagram.com/static/images/ico/apple-touch-icon-76x76-precomposed.png/4272e394f5ad.png'),(4,'https://www.snapchat.com/static/assets/icon_100.png'),(5,'https://s.ytimg.com/yts/img/favicon_32-vflOogEID.png'),(6,'https://www.redditstatic.com/desktop2x/img/favicon/apple-icon-57x57.png'),(7,'https://static.licdn.com/scds/common/u/img/icon/apple-touch-icon.png'),(8,'https://discordapp.com/assets/07dca80a102d4149e9736d4b162cff6f.ico');
...
-- Dump completed on 2019-02-21 20:34:53
